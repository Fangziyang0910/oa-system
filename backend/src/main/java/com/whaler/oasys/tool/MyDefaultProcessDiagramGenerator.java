...
public class MyDefaultProcessDiagramGenerator implements ProcessDiagramGenerator {
    ...
    protected void drawActivity(MyDefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel,
    ...
    * 
    * @param baseElement
    * @return MyDefaultProcessDiagramCanvas.SHAPE_TYPE
    */
    protected static MyDefaultProcessDiagramCanvas.SHAPE_TYPE getShapeType(BaseElement baseElement) {
        if (baseElement instanceof Task || baseElement instanceof Activity || baseElement instanceof TextAnnotation) {
            ...
            return MyDefaultProcessDiagramCanvas.SHAPE_TYPE.Ellipse;
        } else {
    ...
    protected interface ActivityDrawInstruction {
        void draw(MyDefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode);
    }

    protected interface ArtifactDrawInstruction {
        void draw(MyDefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, Artifact artifact);
    }
}
