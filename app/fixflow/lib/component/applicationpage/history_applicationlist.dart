...
class HistoryApplicationListWidget extends StatefulWidget {
  const HistoryApplicationListWidget({super.key});

  @override
  State<HistoryApplicationListWidget> createState() => _HistoryApplicationListWidgetState();
}

class _HistoryApplicationListWidgetState extends State<HistoryApplicationListWidget> {
  ...
  Future<void> _fetchData({bool refresh = false}) async {
    ...
    try {
      final response = await http.get(
        Uri.parse(ApiUrls.listProcessInstancesCompleted),
        headers: {
