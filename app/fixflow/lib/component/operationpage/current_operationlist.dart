...
class CurrentOperationListWidget extends StatefulWidget {
  ...
  @override
  State<CurrentOperationListWidget> createState() => _CurrentOperationListWidgetState();
}

class _CurrentOperationListWidgetState extends State<CurrentOperationListWidget> {
  ...
  Future<void> _fetchData({bool refresh = false}) async {
    ...
    try {
      final response = await http.get(
        Uri.parse(ApiUrls.listOperatorTasksNotCompleted),
        headers: {
