...
import 'package:fixflow/component/operationpage/historyOperationDetail.dart';
...
class HistoryOperationListWidget extends StatefulWidget {
  const HistoryOperationListWidget({super.key});

  @override
  State<HistoryOperationListWidget> createState() => _HistoryOperationListWidgetState();
}

class _HistoryOperationListWidgetState extends State<HistoryOperationListWidget> {
  ...
  Future<void> _fetchData({bool refresh = false}) async {
    ...
    try {
      final response = await http.get(
        Uri.parse(ApiUrls.listOperatorTasksCompleted),
        headers: {
                ...
                itemBuilder: (context, index) {
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      ...
                      subtitle: Text(
                        '运维时间：' + parseDateFormat(task['endTime']),
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => HistoryOperationDetailWidget(
                              taskId: task['taskId'],
                            ),
                          ),
                        );
